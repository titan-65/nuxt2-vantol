...
const lines = [
  ...
  { text: "", delay: 1600 },
  { text: "  ● Reading src/auth/middleware.ts...", delay: 1800 },
  { text: "  ● Running shell: npx tsc --noEmit...", delay: 2200 },
  { text: "  ✓ All types check out.", delay: 2600 },
  { text: "", delay: 2800 },
  { text: "  I'll refactor the middleware to use", delay: 2900 },
  { text: "  a strategy pattern for auth providers.", delay: 3100 },
  { text: "  ● Writing src/auth/strategies/...", delay: 3400 },
  { text: "  ✓ Done. 3 files changed.", delay: 3800 },
];
