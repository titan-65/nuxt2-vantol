...
export default defineNuxtConfig({
  ...
  assistant: {
    ...
    persona: {
      ...
      greeting:
        "Hi! I am Nox, Vantol's assistant. Ask me anything about projects, articles, tutorials, or site navigation!",
    },
  },
  app: {
    viewTransition: true,
    ...
    head: {
      ...
      meta: [
        ...
        { name: "viewport", content: "width=device-width, initial-scale=1" },
        {
          name: "description",
          content:
            "Fullstack Developer- Vantol Bennett. Over 10 years of experience in Web and Mobile development. Vue.js, Nuxtjs, React, Javascript, Node.js and Django (Python) Framework.",
        },
