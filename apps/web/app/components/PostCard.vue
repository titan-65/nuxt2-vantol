...
<template>
  <div class="group flex flex-col bg-[#111] border border-white/10 rounded-xl overflow-hidden hover:border-white/20 transition-all duration-300">
    ...
    <div class="flex-1 p-5 flex flex-col">
      <h3 class="text-base font-semibold leading-snug mb-2 group-hover:text-[#f5c542] transition-colors">
        {{ item.title }}
      </h3>
      ...
      <div class="flex items-center justify-between pt-4 border-t border-white/10 mt-auto">
        <div class="flex items-center gap-3 text-[11px] text-zinc-600">
          ...
          <span class="px-1.5 py-0.5 text-[10px] font-mono border border-white/10 rounded text-zinc-500 uppercase">
            {{ item.language }}
          </span>
        </div>
