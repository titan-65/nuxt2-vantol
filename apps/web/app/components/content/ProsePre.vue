...
<template>
  <div class="relative group my-6 overflow-hidden border border-white/10 rounded-xl">
    <!-- Header/Filename -->
    <div v-if="filename || language" class="flex items-center justify-between px-4 py-2 border-b border-white/10 bg-zinc-900">
    ...
    <pre :class="props.class" class="p-4 overflow-x-auto font-mono text-sm leading-relaxed bg-zinc-900"><slot /></pre>
  </div>
</template>
