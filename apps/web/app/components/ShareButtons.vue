...
<template>
  <div class="flex items-center gap-2">
    ...
    >
      <svg
        class="w-4 h-4 text-gray-600 dark:text-gray-300 group-hover:text-blue-500"
        fill="currentColor"
        viewBox="0 0 24 24"
      >
        <path
    ...
    >
      <svg
        class="w-4 h-4 text-gray-600 dark:text-gray-300 group-hover:text-blue-600"
        fill="currentColor"
        viewBox="0 0 24 24"
      >
        <path
    ...
    >
      <svg
        class="w-4 h-4 text-gray-600 dark:text-gray-300 group-hover:text-blue-700"
        fill="currentColor"
        viewBox="0 0 24 24"
      >
        <path
    ...
    >
      <svg
        v-if="!copied"
        class="w-4 h-4 text-gray-600 dark:text-gray-300 group-hover:text-green-600"
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
