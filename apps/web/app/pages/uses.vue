    ...
    <section class="py-20 border-b border-white/10">
      <div class="max-w-[1088px] mx-auto px-6">
        <div class="max-w-3xl">
          ...
          <h1 class="text-5xl md:text-6xl font-semibold tracking-tight mb-8">Uses</h1>

          <p
            class="text-xl text-zinc-400 font-light leading-relaxed border-l-2 border-white/10 pl-6"
          >
            A comprehensive list of tools, software, and gear I use for development and content
            creation. Updated regularly to reflect my current setup.
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="py-16 md:py-24">
      <div class="max-w-[1088px] mx-auto px-6">
        <div class="space-y-16">
          <div v-for="(category, index) in categories" :key="category.title" class="relative">
            <div
              class="absolute left-0 top-0 bottom-0 w-px bg-white/10 -ml-3 hidden lg:block"
            ></div>
            ...
            <div class="grid lg:grid-cols-4 gap-8">
              ...
              <div class="lg:col-span-3 grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                  <h3
                    class="font-semibold text-sm mb-2 group-hover:text-[#f5c542] transition-colors"
                  >
                    {{ item.name }}
                  </h3>
