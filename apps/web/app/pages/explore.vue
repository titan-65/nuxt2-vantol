        ...
        <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          <div>
            ...
            <h1 class="mt-2 text-3xl md:text-4xl font-semibold tracking-tight">
              Labs, Notes, and Patterns
            </h1>
            <p class="mt-3 text-sm text-zinc-400 max-w-2xl">
              This page is a hub for the stuff I'm testing and learning in public—without the
              pressure of a polished post.
            </p>
          </div>
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <div class="mt-5 border-t border-white/10 pt-4">
              <p
                v-if="card.to"
                class="text-[11px] font-medium text-[#f5c542] flex items-center gap-1"
              >
                Explore
                <svg
                  width="12"
              ...
              <p v-else class="text-[11px] text-zinc-600">Coming soon...</p>
            </div>
          </component>
        </div>
      </section>
