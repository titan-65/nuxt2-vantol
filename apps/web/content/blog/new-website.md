...
Vue.js is my framework of choice in most cases. Nuxt.js provides an "intutitve" developer experience (DX).

::tip
Nuxt.js has zero configuration, allowing for file-system routing, components auto-import and seo friendly for indexing.
::

Paramount to this application using the power modules- Content, that allows for my web app to using MDX for this blog section.
