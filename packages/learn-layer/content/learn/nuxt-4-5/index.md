...
::BlogAlert{type="info"}
Based on the official [Nuxt 4.5 release notes](https://nuxt.com/blog/v4-5). We're learning to _use_ what they shipped, not restating the docs. This release also announces Nuxt 3's upcoming end-of-life (July 31, 2026) — a good nudge to be on v4.
::
