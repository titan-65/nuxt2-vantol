...
You finished [eve-core](/learn/eve-core) and [eve-advanced](/learn/eve-advanced). You know every building block: tools, skills, channels, connections, sandboxes, subagents, schedules, hooks, evals, and deploy. Now we put them to work in one agent that uses _all of them together_.
