...
- **[Building a Nuxt Module: Going Further](/learn/nuxt-modules-advanced)** — _Intermediate._ Server routes, a typed options surface, and tests worth having.
- **[Nuxt Modules Capstone: The Signed Build](/learn/nuxt-modules-capstone)** — _Advanced._ ed25519 signing, a verify endpoint, and a real deploy.
