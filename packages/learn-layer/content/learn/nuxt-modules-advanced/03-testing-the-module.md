...
The e2e tier is slow — it builds a Nuxt app. Push everything you can down a tier and your suite stays fast enough to run on every save. But some things _only_ exist in a real build, and testing those anywhere else proves nothing.
