...
- **[Nuxt Modules Capstone: The Signed Build](/learn/nuxt-modules-capstone)** — _Advanced._ ed25519 keys, build-time signing, a verify endpoint that can't be tricked, and the deploy.
