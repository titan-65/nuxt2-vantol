...
So this series is me fixing that, and you're coming with me. We're a room full of novices where it counts: we know the framework, we just haven't used _these_ features yet.

::BlogAlert{type="info"}
Everything here is based on the official [Nuxt 4.3 release notes](https://nuxt.com/blog/v4-3). We're not replacing the docs — we're learning to actually _use_ what they announced.
::
