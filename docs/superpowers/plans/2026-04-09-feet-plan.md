...
const ModeSchema = Union([Literal("stream"), Literal("summary"), Literal("both")]);
...
export const sessionAttachTool: ToolDefinition = {
  ...
  async execute(params) {
    ...
    try {
      ...
      return {
        content: `Error attaching to session: ${error instanceof Error ? error.message : String(error)}`,
        isError: true,
      };
    }
  },
